...
# from models.hrnet_encoder_feature import HighResolutionNet
# from models.cross_encoder_feature import crossvit_rgb_heatmap_224, crossvit_small_224
...
class CLAM_MB(CLAM_SB):
    def __init__(self, gate = True, size_arg = "small", dropout = False, k_sample=8, n_classes=2,
        ...
        # self.size_dict = {"small": [768, 512, 256], "big": [768, 512, 384]}
        self.size_dict = {"small": [384, 512, 256], "big": [384, 512, 384]}
        size = self.size_dict[size_arg]
        fc = [nn.Linear(size[0], size[1]), nn.ReLU()]
        if dropout:
            fc.append(nn.Dropout(0.25))
